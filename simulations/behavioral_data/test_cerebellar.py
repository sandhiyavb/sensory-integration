...
def single_run(run=1, noise=0.1, weights_trial=0, input_type='both'):
    '''
    ...
    logs.to_csv(data_folder+'test_log_{}_{}.csv'.format(input_type, weights_trial), 
...
if __name__ == '__main__':
    ...
    single_run(sys.argv[1], sys.argv[2], sys.argv[3], sys.argv[4])
# clear keras session (for performance)
    K.clear_session()
